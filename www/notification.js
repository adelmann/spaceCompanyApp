function newUnlock(tab){
	...
	if(tab === "more"){
		document.getElementById("achievementsTabGlyph").className = "smallglyph pull-right glyphicon glyphicon-exclamation-sign";
	}
}

function newNavUnlock(nav){
	document.getElementById(nav + "NavGlyph").className = "smallglyph glyphicon glyphicon-exclamation-sign";
}

function tabClicked(tab){
	document.getElementById(tab + "TabGlyph").className = "smallglyph pull-right glyphicon glyphicon-exclamation-sign hidden";
}

function navClicked(nav){
	document.getElementById(nav + "NavGlyph").className = "smallglyph pull-right glyphicon glyphicon-exclamation-sign hidden";
}
