var Game = (function() {
    ...
    instance.load = function() {
        ...
        if(data && data !== null) {
            ...
            if (this.settings.entries.musicEnabled == true) {
                SIDplayer.playcont();
            } else {
                SIDplayer.pause();
            }
    ...
    instance.loadDelay = function (self, delta) {
        document.getElementById("game").className = "container-fluid";
    ...
    instance.start = function() {
        ...
        this.createInterval("Loading", this.loadDelay, 2000);
...
window.onload = function(){
    ...
    SIDplayer.loadstart('music/Nemesis_the_Warlock.sid',0);
    SIDplayer.pause();
    Game.start();
};
